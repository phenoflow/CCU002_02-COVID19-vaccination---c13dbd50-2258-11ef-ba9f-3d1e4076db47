...
(async () => {
  ...
  await fs.writeFile("ccu002_02-covid19-vaccination-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ccu002_02-covid19-vaccination-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
